...
class AgentTask(BaseModel):
    ...
    metadata: Dict[str, Any] = Field(default_factory=dict, description="Task-specific parameters")
    context: Optional[Dict[str, Any]] = Field(default=None, description="Shared context from previous agents")
...
class Agent(ABC, BaseModel):
    ...
    skills: List[str] = Field(
        default_factory=list, description="Specific skills this agent possesses"
    )
